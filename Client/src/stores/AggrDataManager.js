...
export default class AggrDataManager {
  ...
  constructor(mgr) {
    ...
    autorun(
      () => this.rootMgr.inputValueSet('aggrFilters:AggrFilters', toJS(this.dataFiles)),
      { delay: 1000 }
    );
  };
  ...
  setDataFileUse = (name, use) => {
    this.dataFiles[this.dataFileNameToIdxMap.get(name)].use = use;
  };
